...
//   return (
//     <div className="p-4 md:p-6 lg:p-10 min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 text-gray-900 dark:text-gray-100 min-w-screen">
...
//       {funnel && (
//         <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg mb-8 w-full max-w-4xl mx-auto">
//           <h2 className="text-xl font-semibold mb-4 text-cyan-500 dark:text-cyan-300">
...
//       {statusDistribution && (
//         <div className="bg-white dark:bg-gray-800 p-6 rounded-xl shadow-lg mb-8 w-full max-w-2xl mx-auto">
//           <h2 className="text-xl font-semibold mb-4 text-cyan-500 dark:text-cyan-300">
//             Status Distribution
//           </h2>
//           <div className="w-full h-64 sm:h-72 md:h-80 lg:h-96">
...
//   return (
//     <div
//       className={`flex-1 min-w-[140px] rounded-xl shadow-md p-5 flex flex-col items-center justify-center ${color} ${textColor}`}
//     >
