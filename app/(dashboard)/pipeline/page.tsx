...
//     <>
//       {/* Header */}
//  <div className="flex flex-col md:flex-row items-start md:items-center justify-between pt-8 px-6 pb-4 border-b border-gray-200 dark:border-gray-700">
...
//   <Link
//     href="/pipeline/new"
//     className="flex items-center gap-2 rounded-md bg-blue-600 px-4 py-2 text-sm font-semibold text-white hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 transition"
//   >
//     <FaPlus />
//     Add Application
//   </Link>
