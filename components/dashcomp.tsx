...
//         setStatsData({
//   totalApplications: (data.funnel.applied ?? 0) + (data.funnel.interview ?? 0) + (data.funnel.offer ?? 0) + (data.funnel.rejected ?? 0),
//   interviews: data.funnel.interview ?? 0,
//   offers: data.funnel.offer ?? 0, // <-- match backend
//   successRate: data.funnel.applied && data.funnel.applied > 0
//     ? Math.min(
//         Math.round((data.funnel.offer / data.funnel.applied) * 100),
//         100
//       ) // cap at 100%
//     : 0,
// });
...
//   if (!statsData) return <p className="text-center py-6">Loading stats...</p>;
